...
void setup() {
  ...
  narwals = loadImage("narwals.jpg"); 
  image (rainbow, 0, 0, 1000, 1000);
...
resize(1000,1000);
  ...
  narwals = loadImage("narwals.jpg"); // 5. Change this to match your file name.
}

void draw() {
  // 6. Draw the unicorn using: image(PImage image, int xPosition, int yPosition)
 image (narwals, mouseX, mouseY, 100, 100); 
